...
altura = A "altura" ["bajo","medio","alto"] :: Attribute String
peso = A "peso" ["ligero", "pesado"] :: Attribute String
arbol = Node altura hijoaltura :: DecisionTree String String

hijoaltura :: String -> DecisionTree String String
hijoaltura "alto" = Node  peso hijopesoAlto
hijoaltura "medio" = Node peso hijopesoMedio
hijoaltura "bajo" = Leaf "mujer"

hijopesoAlto :: String -> DecisionTree String String
hijopesoAlto "ligero" = Leaf "hombre"
hijopesoAlto "pesado" = Leaf "hombre"

hijopesoMedio :: String -> DecisionTree String String
hijopesoMedio "ligero" = Leaf "mujer"
hijopesoMedio "pesado" = Leaf "hombre"
